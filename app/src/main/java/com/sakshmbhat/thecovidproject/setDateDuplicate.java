...
public class setDateDuplicate implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    public setDateDuplicate(EditText editText, RelativeLayout relativeLayoutContainingSpinner, Context getCtx){
